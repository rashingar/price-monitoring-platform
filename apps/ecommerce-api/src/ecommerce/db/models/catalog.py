...
class CatalogProductRow(Base):
    ...
    catalog_source: Mapped[str] = mapped_column(
        String, nullable=False, default="sourceCata", server_default="sourceCata"
    )
    ...
    raw_category: Mapped[str] = mapped_column(
        Text, nullable=False, default="", server_default=""
    )
    ...
    category_levels: Mapped[list[str] | None] = mapped_column(
    ...
    is_atomic_model: Mapped[bool] = mapped_column(
