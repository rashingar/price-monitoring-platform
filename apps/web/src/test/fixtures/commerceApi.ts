...
export const sourceUrlCandidateReviewLayout = {
  user_key: "default",
  columns: [
    { key: "id", label: "Candidate id", visible: true, width_px: 110, order: 0 },
    { key: "run_id", label: "Run id", visible: true, width_px: 130, order: 1 },
    { key: "model", label: "Model", visible: true, width_px: 110, order: 2 },
    { key: "product_name", label: "Product", visible: false, width_px: 220, order: 3 },
    { key: "source_name", label: "Source name", visible: true, width_px: 120, order: 4 },
    { key: "candidate_title", label: "Candidate title", visible: true, width_px: 220, order: 5 },
    { key: "candidate_price", label: "Price", visible: true, width_px: 95, order: 6 },
    { key: "confidence_score", label: "Confidence", visible: true, width_px: 105, order: 7 },
    { key: "status", label: "Review status", visible: true, width_px: 130, order: 8 },
