...
def test_openapi_snapshot_contains_ui_facing_routes() -> None:
    ...
    required_routes = {
        ...
        ("POST", "/api/product-factory-batches/upload"),
        ("GET", "/api/product-factory-batches"),
        ("GET", "/api/product-factory-batches/{batch_id}"),
        ("GET", "/api/product-factory-batches/{batch_id}/rows"),
        ("POST", "/api/product-factory-batches/{batch_id}/resolve"),
        ("POST", "/api/product-factory-batches/{batch_id}/rows/{row_id}/select-source"),
        ("POST", "/api/product-factory-batches/{batch_id}/rows/{row_id}/skip"),
