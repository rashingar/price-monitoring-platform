...
from pricefetcher.db.models import OfferObservation, PriceObservation, Product, ProductSource, SourceCaptureSnapshot, Vendor
from pricefetcher.db.repositories import find_product_by_identity, json_safe_value, product_to_dict
...
from pricefetcher.source_capture.types import CaptureResult, ParsedOfferObservation, ParsedPriceObservation
...
def _inline_text_ref(text: str | None, *, kind: str, limit: int = 100_000) -> str | None:
    ...
    if digest is None:
        return None
    artifact_dir = Path(os.environ.get("PRICEFETCHER_SOURCE_CAPTURE_ARTIFACT_DIR", "output/source_capture/artifacts"))
