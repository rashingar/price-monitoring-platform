...
SCHEMA_VERSION = "1.0"
HANDOFF_FILENAME = "ecommerce_source_handoff.json"
...
def write_ecommerce_source_handoff(
    *,
    cli: CLIInput,
    source: str,
    provider_id: str,
    ...
    path = ecommerce_handoff_path(model_dir)
...
def write_ecommerce_source_failure_handoff(
    *,
    cli: CLIInput,
    source: str,
    provider_id: str,
...
def build_ecommerce_source_handoff(
    *,
    cli: CLIInput,
    source: str,
    provider_id: str,
