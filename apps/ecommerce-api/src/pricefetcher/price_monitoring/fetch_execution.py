...
from pricefetcher.db.alerts import evaluate_alert_rules_for_run, has_active_alert_rules
...
MAX_FETCH_WORKERS_ENV_VAR = "PRICEFETCHER_MAX_FETCH_WORKERS"
FETCH_STALE_AFTER_MINUTES_ENV_VAR = "PRICEFETCHER_FETCH_STALE_AFTER_MINUTES"
SUBPROCESS_TERMINATE_TIMEOUT_SECONDS_ENV_VAR = "PRICEFETCHER_SUBPROCESS_TERMINATE_TIMEOUT_SECONDS"
...
def build_execution_command(run_id: str, execution_id: str, execution_type: str) -> list[str]:
    return [
        sys.executable,
        "-m",
        "pricefetcher.jobs.run_price_monitoring_execution",
        "--run-id",
        run_id,
        "--execution-id",
        execution_id,
