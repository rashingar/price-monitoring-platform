...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("payload_json", sa.JSON().with_variant(postgresql.JSONB(), "postgresql"), nullable=True),
    ...
    op.create_index("uq_ecommerce_jobs_job_id", "ecommerce_jobs", ["job_id"], unique=True)
