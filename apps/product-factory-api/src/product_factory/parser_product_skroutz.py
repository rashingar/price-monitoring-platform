...
SKROUTZ_FAMILIES: dict[str, dict[str, Any]] = {
    ...
    "stand_fan": {
        ...
        "title_tokens": {"ορθοστατης", "δαπεδου", "orthostatis", "dapedou", "stand fan", "pedestal fan"},
    ...
    "stick_vacuum": {
        ...
        "category_href_tokens": {"skoupes stick", "skoypes stick", "skoupa stick", "skoypa stick"},
        "title_tokens": {"skoupa stick", "skoypa stick", "stick cheiros", "stick handheld", "2 se 1 stick", "epanafortizomeni skoupa"},
