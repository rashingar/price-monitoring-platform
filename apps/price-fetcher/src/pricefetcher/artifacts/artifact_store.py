...
ARTIFACT_ROOTS_ENV_VAR = "PRICEFETCHER_ARTIFACT_ROOTS"
DEFAULT_ARTIFACT_ROOTS = (
    Path("output") / "bridge" / "runs",
    Path("output") / "price_monitoring" / "runs",
    Path("output") / "source_url_agent" / "runs",
