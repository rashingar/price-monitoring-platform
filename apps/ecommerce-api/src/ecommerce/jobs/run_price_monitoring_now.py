...
from ecommerce.price_monitoring.fetch_run import PriceMonitoringFetchError, run_price_monitoring_fetch
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="Run an existing Ecommerce monitoring fetch now.")
