...
def put_filter_review(model: str, request: FilterReviewUpdateRequest) -> FilterReviewResponse:
    try:
...
@router.post("/{model}/approve", response_model=FilterReviewResponse, responses=_ERROR_RESPONSES)
