...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  "$checks = @(" ^
  "@{Name='Product Factory health'; Url='http://127.0.0.1:8000/api/health'}," ^
  "@{Name='Ecommerce catalog summary'; Url='http://127.0.0.1:8001/api/catalog/summary'}," ^
  "@{Name='Ecommerce file roots'; Url='http://127.0.0.1:8001/api/files/roots'}" ^
