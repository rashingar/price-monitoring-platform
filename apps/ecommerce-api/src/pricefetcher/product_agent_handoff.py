...
from pricefetcher.db.models import CatalogProductRow, Product, ProductSource, SourceCaptureSnapshot
from pricefetcher.db.product_source_repository import persist_capture_result, product_source_to_dict
...
from pricefetcher.source_urls import SourceUrlValidationError, extract_source_domain, infer_source_name, normalize_source_url
...
def parse_product_agent_handoff(path: Path | str) -> ProductAgentHandoff:
    ...
    version = _first_text(
        ...
        payload.get("price_fetcher_source_handoff_schema_version"),
        "v1",
    ).lower()
