...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "  @{ Name = 'Ecommerce catalog summary'; Url = 'http://127.0.0.1:8001/api/catalog/summary'; Hint = 'If ecommerce health works, check PostgreSQL configuration, migrations, and catalog import: python -m ecommerce.jobs.check_db_setup; alembic upgrade head; python -m ecommerce.jobs.ingest_catalog.' }," ^
  ...
  "  Write-Host '      python -m ecommerce.jobs.check_db_setup' -ForegroundColor Yellow;" ^
  "  Write-Host '      alembic upgrade head' -ForegroundColor Yellow;" ^
  "  Write-Host '      python -m ecommerce.jobs.ingest_catalog' -ForegroundColor Yellow" ^
  "}"
