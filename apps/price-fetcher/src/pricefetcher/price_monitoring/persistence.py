...
from pricefetcher.db.models import PriceObservation
from pricefetcher.price_monitoring.fetch_run import PriceMonitoringFetchResult
from pricefetcher.price_monitoring.observations import parse_price_observations_csv
from pricefetcher.price_monitoring.runs import PriceMonitoringRunRecord
    ...
    *,
    ...
    if not is_database_configured():
        return FetchPersistenceResult(
            ...
            warnings=["Database persistence is disabled because PRICEFETCHER_DATABASE_URL is not configured."],
        )
