"""Read-only PostgreSQL setup verification for PriceFetcher."""
...
from pricefetcher.db.config import DATABASE_URL_ENV_VAR
from pricefetcher.db.diagnostics import REQUIRED_PRICE_MONITORING_TABLES, collect_database_status
