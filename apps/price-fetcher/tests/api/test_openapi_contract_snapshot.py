...
def test_openapi_snapshot_contains_ui_facing_routes() -> None:
    ...
    required_routes = {
        ...
        ("GET", "/api/catalog/source-url-agent/candidates"),
        ("GET", "/api/catalog/source-url-agent/candidates/review-layout"),
        ("PUT", "/api/catalog/source-url-agent/candidates/review-layout"),
        ("POST", "/api/catalog/source-url-agent/candidates/review-layout/reset"),
        ("GET", "/api/catalog/source-url-agent/candidates/{candidate_id}"),
        ("PATCH", "/api/catalog/source-url-agent/candidates/{candidate_id}/review"),
        ("GET", "/api/vendor-sources/sources"),
        ("GET", "/api/vendor-sources/source-urls/summary"),
        ("GET", "/api/vendor-sources/source-health"),
        ("POST", "/api/vendor-sources/captures/run"),
