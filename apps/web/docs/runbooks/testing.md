...
These tests do not require Product Factory or ecommerce-api to be running. They do not use live network calls, real CSV files, local Windows paths, PostgreSQL, OpenCart, OpenAI, backend subprocesses, or browser end-to-end tooling.
...
blocking conditions; neither must imply the commerce health, files, paths, or
