...
from pricefetcher.artifacts import artifact_link_payload, is_artifact_path_allowed
from pricefetcher.catalog import MissingCatalogColumnsError
from pricefetcher.db.config import sanitize_database_error
from pricefetcher.db.diagnostics import collect_run_persistence_status
from pricefetcher.db.policy import (
    collect_price_monitoring_database_readiness,
    require_database_ready_for_price_monitoring,
)
from pricefetcher.db.repositories import (
...
from pricefetcher.file_editor.safe_paths import get_allowed_roots, is_path_allowed
from pricefetcher.ignore import MissingIgnoreColumnsError
from pricefetcher.price_monitoring.export import export_price_update_csv
from pricefetcher.price_monitoring.fetch_execution import (
...
from pricefetcher.price_monitoring.fetch_run import (
    load_price_monitoring_fetch_result,
)
from pricefetcher.price_monitoring.persistence import (
    persist_run_creation_if_configured,
)
from pricefetcher.price_monitoring.review import (
    PriceActionInput,
    PriceReviewError,
    apply_price_actions,
...
from pricefetcher.price_monitoring.selection import (
    PriceMonitoringFilters,
    PriceMonitoringSelectionRequest,
    PriceMonitoringSelectionResult,
    select_price_monitoring_products,
)
from pricefetcher.price_monitoring.source_url_coverage import (
    compute_source_url_coverage,
    require_active_source_url_coverage,
)
from pricefetcher.vendor_sources.capture import run_vendor_source_capture
...
def _fetch_result_persistence_payload(run_id: str) -> dict[str, object]:
    ...
    if persistence_status == "not_configured":
        warnings.append("Database persistence is disabled because PRICEFETCHER_DATABASE_URL is not configured.")
