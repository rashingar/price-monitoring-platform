...
from pricefetcher.db.models import CatalogProductRow, Product, ProductSource, SourceUrl, Vendor
from pricefetcher.db.repositories import upsert_product_from_catalog_row
...
from pricefetcher.source_urls import extract_source_domain, infer_source_name, normalize_source_url
