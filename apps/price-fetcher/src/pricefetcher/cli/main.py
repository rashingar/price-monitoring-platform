...
from pricefetcher.source_capture.product_agent_import import DEFAULT_PRODUCT_AGENT_WORK_ROOT, import_product_agent_artifacts
from pricefetcher.source_capture.scheduled import capture_due_product_sources


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="pricefetcher")
