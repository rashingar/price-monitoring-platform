...
if defined PRICE_FETCHER_DIR (
  ...
  set "PRICE_FETCHER_ROOT=%UI_ROOT%\..\ecommerce-api"
)
...
if not exist "%PRICE_FETCHER_ROOT%" (
  echo ERROR: ecommerce-api directory was not found.
  echo Set PRICE_FETCHER_DIR to the local ecommerce-api app path.
  echo.
  pause
  exit /b 1
)
