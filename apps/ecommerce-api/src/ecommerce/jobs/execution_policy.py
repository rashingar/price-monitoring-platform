...
def api_execute_durable_jobs_inline_enabled(env: Mapping[str, str] | None = None) -> bool:
    ...
    raw_value = str(source.get(API_EXECUTE_DURABLE_JOBS_INLINE_ENV_VAR, "") or "").strip().lower()
    if not raw_value:
