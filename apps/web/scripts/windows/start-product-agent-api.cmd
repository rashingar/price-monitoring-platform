...
if defined PRODUCT_AGENT_DIR (
  ...
  set "PRODUCT_AGENT_ROOT=%UI_ROOT%\..\product-factory-api"
)

for %%I in ("%PRODUCT_AGENT_ROOT%") do set "PRODUCT_AGENT_ROOT=%%~fI"
set "PRODUCT_AGENT_SCRAPER=%PRODUCT_AGENT_ROOT%\src"
...
if not exist "%PRODUCT_AGENT_SCRAPER%" (
  echo ERROR: Missing Product Factory src folder.
  pause
  exit /b 1
)
...
if not exist "..\.venv\Scripts\python.exe" (
  echo ERROR: Missing Product-Agent virtual environment: product-factory-api\.venv
