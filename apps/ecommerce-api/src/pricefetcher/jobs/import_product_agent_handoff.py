"""Import Product-Agent price_fetcher_source_handoff.json artifacts."""
...
from pricefetcher.product_agent_handoff import import_product_agent_handoff


def main(argv: Sequence[str] | None = None) -> int:
    load_local_env_if_present()
    parser = argparse.ArgumentParser(description="Import Product-Agent source URL handoff artifacts.")
    parser.add_argument("--file", required=True, type=Path, help="Path to price_fetcher_source_handoff.json.")
