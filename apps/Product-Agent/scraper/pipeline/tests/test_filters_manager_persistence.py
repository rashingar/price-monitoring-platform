...
from pipeline.api.schemas import AddFilterGroupRequest
from pipeline.services.filters_manager_service import (
...
def test_sync_failure_during_normal_write_leaves_previous_manual_recoverable(
    ...
    patcher.setattr("pipeline.services.filters_manager_service.write_filter_map_json", failing_write)
