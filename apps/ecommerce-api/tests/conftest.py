...
_MODULE_MARKERS: dict[str, tuple[str, ...]] = {
    ...
    "test_price_monitoring_alerts.py": ("integration", "runtime"),
    "test_price_monitoring_api.py": ("smoke", "integration", "runtime"),
    "test_price_monitoring_db.py": ("integration", "runtime"),
    ...
    "test_source_capture_unified.py": ("integration", "runtime"),
    "test_source_catalog.py": ("contract",),
    "test_source_url_agent.py": ("integration", "runtime"),
    ...
    "test_vendor_sources_capture.py": ("integration", "runtime"),
}
