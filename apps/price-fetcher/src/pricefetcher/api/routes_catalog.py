...
from pricefetcher.catalog import CatalogProduct
from pricefetcher.catalog_db import load_active_catalog_products
...
from pricefetcher.ignore import MissingIgnoreColumnsError, load_ignored_products
...
def _empty_catalog_warning(products: list[CatalogProduct]) -> dict[str, str]:
    if products:
        return {}
    return {"warning": "Active catalog is empty. Run python -m pricefetcher.jobs.ingest_catalog."}
